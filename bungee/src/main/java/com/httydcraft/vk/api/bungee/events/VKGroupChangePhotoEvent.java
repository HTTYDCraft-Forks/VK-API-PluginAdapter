...
public class VKGroupChangePhotoEvent extends AbstractVkEvent {
	...
	// region Constructors
	/**
	 * Constructs a group photo change event with the specified photo change info and group ID.
	 *
	...
	/**
	 * Returns the group photo change information.
	 *
	...
	/**
	 * Sets the group photo change information.
	 *
