...
/**
 * Event triggered when a user is allowed messaging in a VK group.
 */
public class VKMessageAllowEvent extends AbstractVkEvent {
	...
	// region Constructors
	/**
	 * Constructs a message allow event with the specified allow info and group ID.
	 *
	...
	/**
	 * Returns the message allow information.
	 *
	...
	/**
	 * Returns the user ID associated with the allow event.
	 *
	 * @return the user ID
	 */
	...
	/**
	 * Sets the message allow information.
	 *
