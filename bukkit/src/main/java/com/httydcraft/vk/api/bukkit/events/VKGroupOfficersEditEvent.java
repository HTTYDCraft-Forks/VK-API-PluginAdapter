...
public class VKGroupOfficersEditEvent extends AbstractVkEvent {
	...
	// region Constructors
	/**
	 * Constructs a group officers edit event with the specified officers edit and group ID.
	 *
	...
	/**
	 * Returns the group officers edit object associated with this event.
	 *
	...
	/**
	 * Sets the group officers edit object for this event.
	 *
