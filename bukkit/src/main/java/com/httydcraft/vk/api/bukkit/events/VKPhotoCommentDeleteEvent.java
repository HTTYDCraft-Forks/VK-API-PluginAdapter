...
public class VKPhotoCommentDeleteEvent extends AbstractVkEvent {
	...
	// region Constructors
	/**
	 * Constructs a photo comment delete event with the specified photo comment deletion and group ID.
	 *
	...
	/**
	 * Returns the photo comment deletion object associated with this event.
	 *
	...
	/**
	 * Sets the photo comment deletion object for this event.
	 *
