...
public class VKMessageTypingEvent extends AbstractVkEvent {
	...
	// region Constructors
	/**
	 * Constructs a message typing event with the specified message typing object and group ID.
	 *
	...
	/**
	 * Returns the message typing object associated with this event.
	 *
	...
	/**
	 * Returns the typing state associated with this event.
	 *
	...
	/**
	 * Returns the recipient ID associated with this event.
	 *
	...
	/**
	 * Returns the sender ID associated with this event.
	 *
	...
	/**
	 * Sets the message typing object for this event.
	 *
