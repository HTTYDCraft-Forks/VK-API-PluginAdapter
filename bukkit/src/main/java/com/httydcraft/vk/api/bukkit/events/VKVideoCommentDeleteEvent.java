...
public class VKVideoCommentDeleteEvent extends AbstractVkEvent {
	...
	// region Constructors
	/**
	 * Constructs a video comment delete event with the specified video comment deletion and group ID.
	 *
	...
	/**
	 * Returns the video comment deletion object associated with this event.
	 *
	...
	/**
	 * Sets the video comment deletion object for this event.
	 *
