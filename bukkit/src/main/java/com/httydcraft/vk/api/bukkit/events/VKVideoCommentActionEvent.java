...
/**
 * Abstract base class for VK video comment-related action events.
 */
public abstract class VKVideoCommentActionEvent extends AbstractVkEvent {
	...
	// region Constructors
	/**
	 * Constructs a video comment action event with the specified video comment and group ID.
	 *
	 ...
	 *
	 * @param videoComment the video comment object to set
