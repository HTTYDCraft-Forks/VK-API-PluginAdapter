...
public class VKUserGroupLeaveEvent extends AbstractVkEvent {
	...
	// region Constructors
	/**
	 * Constructs a user group leave event with the specified leave object and group ID.
	 *
	...
	/**
	 * Returns the group leave object associated with this event.
	 *
	...
	/**
	 * Sets the group leave object for this event.
	 *
