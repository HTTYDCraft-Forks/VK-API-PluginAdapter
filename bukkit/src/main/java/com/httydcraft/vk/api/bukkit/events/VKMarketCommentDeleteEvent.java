...
public class VKMarketCommentDeleteEvent extends AbstractVkEvent {
	...
	// region Constructors
	/**
	 * Constructs a market comment delete event with the specified comment deletion and group ID.
	 *
	...
	/**
	 * Returns the market comment deletion object associated with this event.
	 *
	...
	/**
	 * Sets the market comment deletion object for this event.
	 *
