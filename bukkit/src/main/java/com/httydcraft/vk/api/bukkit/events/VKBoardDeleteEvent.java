...
public class VKBoardDeleteEvent extends AbstractVkEvent {
	...
	// region Constructors
	/**
	 * Constructs a board delete event with the specified board post deletion and group ID.
	 *
	...
	/**
	 * Returns the board post deletion object associated with this event.
	 *
	...
	/**
	 * Sets the board post deletion object for this event.
	 *
