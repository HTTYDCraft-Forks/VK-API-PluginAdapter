...
/**
 * Abstract base class for VK photo comment-related action events.
 */
public abstract class VKPhotoCommentActionEvent extends AbstractVkEvent {
	...
	// region Constructors
	/**
	 * Constructs a photo comment action event with the specified photo comment and group ID.
	 *
	 ...
	 *
	 * @param photoComment the photo comment object to set
