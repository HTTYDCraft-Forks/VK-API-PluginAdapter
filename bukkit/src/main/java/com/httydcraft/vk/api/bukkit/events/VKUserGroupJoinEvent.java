...
public class VKUserGroupJoinEvent extends AbstractVkEvent {
	...
	// region Constructors
	/**
	 * Constructs a user group join event with the specified join object and group ID.
	 *
	...
	/**
	 * Returns the group join object associated with this event.
	 *
	...
	/**
	 * Sets the group join object for this event.
	 *
